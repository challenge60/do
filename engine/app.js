...
function renderSettings(){
  ...
  app.innerHTML = `
    ...
    <div class="section-card">
      ...
      ${(typeof supabaseClient === "undefined" || !supabaseClient || window.isAdmin) ? `
      <div style="margin-top:16px;padding-top:14px;border-top:1px solid var(--line);">
        <div class="label" style="font-weight:700;margin-bottom:6px;">학습데이터만 백업${typeof supabaseClient !== "undefined" && supabaseClient ? ' <span style="font-size:0.68rem;color:var(--amber);font-weight:800;">(관리자)</span>' : ''}</div>
      ...
      <div style="margin-top:16px;padding-top:14px;border-top:1px solid var(--line);">
        <div class="label" style="font-weight:700;margin-bottom:6px;">외부데이터 복원${typeof supabaseClient !== "undefined" && supabaseClient ? ' <span style="font-size:0.68rem;color:var(--amber);font-weight:800;">(관리자)</span>' : ''}</div>
